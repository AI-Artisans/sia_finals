<div class="container mt-5">
    ...
    <form action="<?= site_url('user/update') ?>" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="drivers_license_number" name="drivers_license_number" value="<?= htmlspecialchars($user['drivers_license_number']) ?>" placeholder="Enter your driver's license number" required readonly>
        </div>
        <div class="mb-3">
            <label for="drivers_license_expiry" class="form-label">Driver's License Expiry</label>
            <input type="date" class="form-control" id="drivers_license_expiry" name="drivers_license_expiry" value="<?= htmlspecialchars($user['drivers_license_expiry']) ?>" required readonly >
        </div>
